...
public class UsefulInfoActivity extends BaseActivity {
    ...
    @BindString(R.string.faq1_question) String faq1_question;
    @BindString(R.string.faq1_answer) String faq1_answer;
    @BindString(R.string.faq2_question) String faq2_question;
    @BindString(R.string.faq2_answer) String faq2_answer;
    @BindString(R.string.faq3_question) String faq3_question;
    @BindString(R.string.faq3_answer) String faq3_answer;
    @BindString(R.string.faq4_question) String faq4_question;
    @BindString(R.string.faq4_answer) String faq4_answer;
    @BindString(R.string.faq5_question) String faq5_question;
    @BindString(R.string.faq5_answer) String faq5_answer;
    @BindString(R.string.faq6_question) String faq6_question;
    @BindString(R.string.faq6_answer) String faq6_answer;
    @BindString(R.string.faq7_question) String faq7_question;
    @BindString(R.string.faq7_answer) String faq7_answer;
    @BindString(R.string.faq8_question) String faq8_question;
    @BindString(R.string.faq8_answer) String faq8_answer;
    @BindString(R.string.faq9_question) String faq9_question;
    @BindString(R.string.faq9_answer) String faq9_answer;
    @BindString(R.string.faq10_question) String faq10_question;
    @BindString(R.string.faq10_answer) String faq10_answer;
